...
SPACESHIP_YELLOW_PIC = pygame.image.load(os.path.join('Assets','spaceship_yellow.png'))
SPACESHIP_YELLOW = pygame.transform.rotate(pygame.transform.scale(SPACESHIP_YELLOW_PIC, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)

SPACESHIP_RED_PIC = pygame.image.load(os.path.join('Assets','spaceship_red.png'))
SPACESHIP_RED = pygame.transform.rotate(pygame.transform.scale(SPACESHIP_RED_PIC, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), -90)
